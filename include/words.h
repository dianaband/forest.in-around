...
#define BELL_WORD_SLEEPING           (ID_BELL + 0x01)
#define BELL_WORD_RING_RING_RING     (ID_BELL + 0x02)

#define FLOAT_WORD_HELLO             (ID_FLOAT + 0x00)
#define FLOAT_WORD_SLEEPING          (ID_FLOAT + 0x01)
#define FLOAT_WORD_TURN_TURN         (ID_FLOAT + 0x02)

#define BAG_WORD_HELLO               (ID_BAG + 0x00)
#define BAG_WORD_SLEEPING            (ID_BAG + 0x01)
#define BAG_WORD_HANDLE_UP           (ID_BAG + 0x02)
#define BAG_WORD_HANDLE_DOWN         (ID_BAG + 0x03)
#define BAG_WORD_SING                (ID_BAG + 0x04)

#define LOOK_WORD_HELLO              (ID_LOOK + 0x00)
#define LOOK_WORD_SLEEPING           (ID_LOOK + 0x01)
#define LOOK_WORD_LOOK_AROUND        (ID_LOOK + 0x02)

#define WINDMILL_WORD_HELLO          (ID_WINDMILL + 0x00)
#define WINDMILL_WORD_SLEEPING       (ID_WINDMILL + 0x01)
#define WINDMILL_WORD_BLOW           (ID_WINDMILL + 0x02)

#define GLASS_WORD_HELLO             (ID_GLASS + 0x00)
#define GLASS_WORD_SLEEPING          (ID_GLASS + 0x01)
#define GLASS_WORD_PLAYTIME          (ID_GLASS + 0x02)

#define REEL_WORD_HELLO              (ID_REEL + 0x00)
#define REEL_WORD_SLEEPING           (ID_REEL + 0x01)
#define REEL_WORD_PLAYTIME           (ID_REEL + 0x02)

#define ARROW_WORD_HELLO             (ID_ARROW + 0x00)
#define ARROW_WORD_SLEEPING          (ID_ARROW + 0x01)
#define ARROW_WORD_CHANGE            (ID_ARROW + 0x02)

#define THUNDER_WORD_HELLO           (ID_THUNDER + 0x00)
#define THUNDER_WORD_SLEEPING        (ID_THUNDER + 0x01)
#define THUNDER_WORD_RRRRR           (ID_THUNDER + 0x02)
#define THUNDER_WORD_LEFT            (ID_THUNDER + 0x03)

#define FUR_WORD_HELLO               (ID_FUR + 0x00)
#define FUR_WORD_SLEEPING            (ID_FUR + 0x01)
#define FUR_WORD_SING                (ID_FUR + 0x02)

#define PEAK_WORD_HELLO              (ID_PEAK + 0x00)
#define PEAK_WORD_SLEEPING           (ID_PEAK + 0x01)
#define PEAK_WORD_PPI_PPI_PPI        (ID_PEAK + 0x02)
...
#define MONITOR_WORD_WAKEUP          (ID_MONITOR + 0x00)
#define MONITOR_WORD_SLEEP           (ID_MONITOR + 0x01)
